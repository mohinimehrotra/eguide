...
<h1 class="text-center"><b>WELCOME TO PATNA!</b> </h1><br><br>
<div class="row">
...
<div class="col-md-3"><a href="patnah.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="patnar.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="patnatr.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
