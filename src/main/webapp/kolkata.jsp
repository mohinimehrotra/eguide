...
.back-img {
   background: url("citiesimg/kolkata.jpg");
   height: 40vh;
   width: 100%;
...
<div class="col-md-3"><a href="kolkatah.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="kolkatar.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="kolkatatr.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
