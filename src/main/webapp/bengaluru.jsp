...
.back-img {
   background: url("citiesimg/beng.jpg");
   height: 40vh;
   width: 100%;
...
<h1 class="text-center"><b>WELCOME TO BENGALURU!</b> </h1><br><br>
<div class="row">
...
<div class="col-md-3"><a href="bengaluruh.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="bengalurur.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="bengalurutr.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
