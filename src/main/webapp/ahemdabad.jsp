...
<h1 class="text-center"><b>WELCOME TO AHEMDABAD!</b> </h1><br><br>
<div class="row">
...
<div class="col-md-3"><a href="ahemdabadh.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="ahemdabadr.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="ahemdabadtr.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
