...
.back-img {
   background: url("citiesimg/delhi.jpg");
   height: 40vh;
   width: 100%;
...
<h1 class="text-center"><b>WELCOME TO DELHI!</b> </h1><br><br>
<div class="row">
...
<div class="col-md-3"><a href="newdelhih.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="newdelhir.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="newdelhitr.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
