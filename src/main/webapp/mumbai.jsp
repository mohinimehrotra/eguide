...
<title>cities: mumbai</title>
<%@ include file="all_component/allCss.jsp" %>
<style type="text/css">

.back-img {
   background: url("citiesimg/mumb.jpg");
   height: 40vh;
   width: 100%;
...
<h1 class="text-center"><b>WELCOME TO MUMBAI!</b> </h1><br><br>
<div class="row">
...
<div class="col-md-3"><a href="mumbh.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="mumbr.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="mumbtr.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
