...
.back-img {
   background: url("tourist/agratr1.jpg");
   height: 40vh;
   width: 100%;
...
<h1 class="text-center"><b>WELCOME TO AGRA!</b> </h1><br><br>
<div class="row">
...
<div class="col-md-3"><a href="agrah.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="agrar.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
...
<div class="text-center mt-3">
				...
				<div class="col-md-3"><a href="agratr.jsp">
				<div class="card crd-ho">
					<div class="card-body text-center">
